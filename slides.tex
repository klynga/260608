...
\author[]{Yngvil Beyer, Jon Atle Gulla, \alert{Lilja Øvrelid}, Stephan Oepen\vskip -4ex}
...
\begin{frame}[fragile]\includelogo
  ...
  \begin{columns}
    \begin{column}{.6\textwidth}
      \begin{center}
        \fbox{\includegraphics[width=.86\textwidth]{graphics/anbefalinger}}\\[1.5ex]
      \end{center}
    \end{column}
...
\begin{frame}[fragile]\includelogo
  \frametitle{For eksempel:\ NorGLM (EMNLP 2024)}
  \vskip -4ex
  \begin{center}
    \fboxsep 3pt
    \fbox{\includegraphics[width=.65\textwidth]{graphics/norglm}}\\
    \color{DarkGreen}{\smaller\url{https://aclanthology.org/2024.emnlp-main.317/}}
  \end{center}
\end{frame}
...
\begin{frame}[fragile]\includelogo
  \frametitle{For eksempel:\ Norsk post-trening (ICLR 2026)}
  \vskip -4ex
  \begin{center}
...
\begin{frame}[fragile]\includelogo
  \frametitle{For eksempel:\ Nordisk samarbeid (LREC 2026)}
  \vskip -1ex
  \begin{center}
    \fbox{\includegraphics[width=.75\textwidth]{graphics/trustllm}}\\[0ex]
    \color{DarkGreen}{\smaller\url{https://lrec.elra.info/lrec2026-main-838}}
  \end{center}
\end{frame}

\begin{frame}[fragile]\includelogo
  \frametitle{For eksempel:\ Europeisk samarbeid (LREC 2026)}
  \vskip -4ex
  \begin{center}
    \fbox{\includegraphics[width=.675\textwidth]{graphics/hplt3}}\\[-.5ex]
    \color{DarkGreen}{\smaller\url{https://lrec.elra.info/lrec2026-main-110}}
  \end{center}
\end{frame}

\begin{frame}[fragile]\includelogo
  \frametitle{Regnekraft, for eksempel:\ OpenEuroLLMs GPU-kalkulator}
  \vskip -1ex
  \begin{center}
    \fbox{\includegraphics[width=.9\textwidth]{graphics/kalkulator}}
  \end{center}
  \vskip -.5ex
  \begin{block}{}
    \begin{center}
...
\begin{frame}[fragile]\includelogo
  ...
  \begin{block}{Flere FoU-medlemmer og observatører}
    \begin{center}
      \scshape\color{DarkBlue}
      samiske fagmiljøer ved sámi allaskuvla og uit; ki norge; \ldots
    \end{center}
  \end{block}
  \pause
  \vskip .6ex
  \begin{beamercolorbox}[rounded=true]{block title}
    Samarbeid med ALT-EDIC:\ norsk instans av Compar:IA-arena
  \end{beamercolorbox}
  \vskip .3ex
  \pause
  \begin{block}{Språkmodeller og digital suverenitet:\ Hva er Norges strategi?}
    \begin{center}
      \scshape\color{DarkBlue}
      \vskip -.2ex
      \raisebox{-.8ex}{\includegraphics[height=3ex]{graphics/arendal}}
      13.\ august:\ sigrun aasland, hans christian holte, åse wetås, \ldots
      \vskip -.5ex
    \end{center}
  \end{block}
  \pause
  \begin{block}{Felles forskningsinfrastruktur:\ data, evaluering, programvare}
    \begin{center}
      \scshape\color{DarkBlue}
      enhetlig oppsett på olivia og lumi; standardisert evaluering
    \end{center}
  \end{block}
  \pause
  \vskip .6ex
  \begin{beamercolorbox}[rounded=true]{block title}
    September--oktober:\ Fysisk heldagssamling med flere forskere
  \end{beamercolorbox}
  \vskip .3ex
  \pause
  \begin{block}{November--desember:\ \textit{Nordic LLM Summit}}
    \begin{center}
      \scshape\color{DarkBlue}
        samle forskere fra danmark, island, finland, sverige:\ «hands-on»
    \end{center}
  \end{block}
